...
namespace Sanatorium.Views
{
    ...
    /// do użycia:
    ///
    ///     xmlns:MyNamespace="clr-namespace:Sanatorium.Views"
    ///
    ///
    ...
    /// do użycia:
    ///
    ///     xmlns:MyNamespace="clr-namespace:Sanatorium.Views;assembly=Sanatorium.Views"
    ///
    ...
    ///
    ///     <MyNamespace:WszyscyViewBase/>
    ///
    /// </summary>
    public class WszyscyViewBase : UserControl
    {
        static WszyscyViewBase()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(WszyscyViewBase), new FrameworkPropertyMetadata(typeof(WszyscyViewBase)));
        }
    }
}
